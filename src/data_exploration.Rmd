...
meta_16 = Metadata %>%
  filter(Year == "2016")
asvs_15 = asvs_counts.renamed[,colnames(asvs_counts.renamed) %in% meta.15$SampleNo]
rownames(asvs_15) = asvs_taxonomy$X1
asvs_16 = asvs_counts.renamed[,colnames(asvs_counts.renamed) %in% meta.16$SampleNo]
