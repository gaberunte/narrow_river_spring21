...
narrow.perm = adonis(narrow.diss~ sample_data(phy.15)$Depth+sample_data(phy.15)$Temp+sample_data(phy.15)$LocnDescriptor+sample_data(phy.15)$DO_pct+sample_data(phy.15)$Cond+sample_data(phy.15)$Sal+sample_data(phy.15)$DO_mgL+sample_data(phy.15)$"chl-a"+sample_data(phy.15)$Lugols+sample_data(phy.15)$Glut, data=Metadata )
narrow.perm$aov.tab
...
Main Drivers Year 16
```{r}
narrow.diss = phyloseq::distance(phy.16, method = "bray")
narrow.perm = adonis(narrow.diss~ sample_data(phy.16)$Depth+sample_data(phy.16)$Temp+sample_data(phy.16)$LocnDescriptor+sample_data(phy.16)$DO_pct+sample_data(phy.16)$Cond, data=Metadata )
narrow.perm$aov.tab
```
